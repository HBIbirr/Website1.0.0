...
export const ICONS = {
  ...
  Bilibili: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 10c0-2.209 1.791-4 4-4h10c2.209 0 4 1.791 4 4v7c0 2.209-1.791 4-4 4H7c-2.209 0-4-1.791-4-4v-7z"/><path d="M8 2l2 4M16 2l-2 4"/><path d="M9 13v2M15 13v2"/></svg>
  ),
  Youtube: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.42a2.78 2.78 0 0 0-1.94 2C1 8.14 1 11.86 1 11.86s0 3.72.42 5.44a2.78 2.78 0 0 0 1.94 2C5.12 19.72 12 19.72 12 19.72s6.88 0 8.6-.42a2.78 2.78 0 0 0 1.94-2C23 15.58 23 11.86 23 11.86s0-3.72-.42-5.44z"/><polygon points="9.75 15.02 15.5 11.86 9.75 8.7" fill="currentColor"/></svg>
  )
};
...
export const MOCK_POSTS: any[] = [
  {
    id: '1',
    type: 'image',
    content: 'https://picsum.photos/seed/artsy1/800/600',
    caption: '今天的练琴时光感觉很特别，捕捉到了那一抹夕阳的余晖。',
    timestamp: Date.now() - 3600000,
    likes: 12,
    isLiked: false,
    comments: [
      { id: 'c1', author: '小雅', text: '光影感太美了！', timestamp: Date.now() - 3000000, likes: 3, isLiked: false }
    ]
  },
  {
    id: '2',
    type: 'text',
    content: '',
    caption: '我终于完成了《月光奏鸣曲》的简化版转谱，适合初学者！快去资源区看看吧。',
...
export const MOCK_RESOURCES: any[] = [
  {
    ...
    difficulty: '中级',
    fileUrl: '#',
    coverImage: 'https://picsum.photos/seed/piano1/400/500',
    description: '德彪西名作的易上手版本，去掉了复杂的跨度。',
    status: 'available'
  },
  {
    id: 's2',
    ...
    difficulty: '简单',
    fileUrl: '#',
    coverImage: 'https://picsum.photos/seed/piano2/400/500',
    description: '李闰珉的经典钢琴曲，旋律优美动人。',
    status: 'available'
  },
  {
    id: 'r1',
    ...
    category: '绘画',
    fileUrl: '#',
    coverImage: 'https://picsum.photos/seed/art1/400/500',
    description: '一幅描绘森林清晨光影的水彩作品。',
    status: 'pending'
  },
  {
    id: 'r2',
    ...
    author: 'HBIbirr',
    fileUrl: '#',
    coverImage: 'https://picsum.photos/seed/book1/400/500',
    description: '关于音乐、梦想与孤独的短篇故事集。',
    status: 'maintenance'
  }
];
